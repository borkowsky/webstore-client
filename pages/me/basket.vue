...
<template>
  <div class="page_sectioned_container">
    <div class="side_menu">
      ...
      <div v-if="selectedItems.filter(i => i.available).length" class="px-4 table_list">
        <div class="list_item">
          <div>
            {{ t('total') }}
          </div>
      ...
      <button class="order_button"
              :disabled="!selectedItems.length || !addresses?.length || !canProcessOrder"
      ...
      <div class="scrolling_page_container">
        ...
        <div>
          <div v-if="basket.length" class="basket_list">
            ...
            >
              <div class="item_selector" style="pointer-events: all;">
              ...
              <div class="item_content">
                ...
                <div class="description">
                  <div v-if="item.product?.available" class="font-semibold text-base">
